...
const GamePage = () => {
  ...
  const handleSubmitScore = async () => {
    ...
    try {
      ...
      console.log('Supabase getUser response:', data, error); // Log the response for inspection
      ...
      const user = data.user;  // Access user safely
      const profileId = user.id; // Now you can safely access user.id
