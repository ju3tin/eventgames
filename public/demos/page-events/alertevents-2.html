...
$(document).on("pagecreate", function () {
    ...
    var headerHTML = `
        <div data-role="header" class="jqm-header ui-header ui-bar-inherit" role="banner">
            <h2 class="ui-title">
                <a href="../">
                    <img src="../_assets/img/jquery-logo.png" alt="jQuery Mobile">
                </a>
            </h2>
            <p><span class="jqm-version">${version}</span> ${title}</p>
            <a href="#" class="jqm-navmenu-link ui-btn ui-icon-bars ui-btn-icon-notext ui-btn-left ui-corner-all">Menu</a>
            <a href="#" class="jqm-search-link ui-btn ui-icon-search ui-btn-icon-notext ui-btn-right ui-corner-all">Search</a>
        </div>
    `;

    $("#header-placeholder").html(headerHTML).enhanceWithin();
});
</script> <div data-role="header" class="jqm-header" style="display:none">
